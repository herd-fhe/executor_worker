...
from worker import generate_data_frame, random_uuid, reduce_task, decrypt_data_frame
...
def test_reduce_mixed_circuit(stub, crypto_tool, session, key: Tuple[str, str]):
